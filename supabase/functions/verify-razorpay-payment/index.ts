...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    const { data: order, error: orderError } = await adminClient
      .from("orders")
      .select("id, order_id, user_id, razorpay_order_id, payment_status, payment_provider, payment_method, razorpay_payment_id, razorpay_signature, payment_verified_at, review_reward_coupon_id, review_reward_discount_amount, status")
